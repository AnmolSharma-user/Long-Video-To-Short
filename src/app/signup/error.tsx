    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-violet-900">
      <div className="container mx-auto flex min-h-screen flex-col items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="mb-4 text-3xl font-bold text-white">Signup Error</h1>
          <p className="mb-8 text-lg text-gray-400">
            We encountered an error while processing your signup request.
            {error.message && (
...
// Error boundary component for catching client-side errors
export function ErrorBoundary({ error }: { error: Error }) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-violet-900 flex items-center justify-center">
